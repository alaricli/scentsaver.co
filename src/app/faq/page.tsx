...
export default function FAQPage() {
  return (
    <div className="container mx-auto max-w-3xl p-16">
      ...
      {/* Question 1 */}
      <section aria-labelledby="Q1" className="mb-6">
        <header>
          <h2 id="q1" className="text-xl font-bold">
            What Is scentsaver.co?
          </h2>
        </header>
        <p className="mt-2">
      ...
      {/* Question 2 */}
      <section aria-labelledby="Q2" className="mb-6">
        <header>
      ...
      {/* Question 3 */}
      <section aria-labelledby="Q3" className="mb-6">
        <header>
          <h2 id="q3" className="text-xl font-bold">
      ...
      {/* Question 4 */}
      <section aria-labelledby="Q4" className="mb-6">
        <header>
          <h2 id="q4" className="text-xl font-bold">
      ...
      {/* Question 5 */}
      <section aria-labelledby="Q5" className="mb-6">
        <header>
          <h2 id="q5" className="text-xl font-bold">
            How Long Will a Decant Last?
          </h2>
        </header>
        <p className="mt-2">
      ...
      {/* Question 6 */}
      <section aria-labelledby="Q6" className="mb-6">
        <header>
          <h2 id="q6" className="text-xl font-bold">
      ...
      {/* Question 7 */}
      <section aria-labelledby="Q7" className="mb-6">
        <header>
          <h2 id="q7" className="text-xl font-bold">
      ...
      {/* Question 8 */}
      <section aria-labelledby="Q8" className="mb-6">
        <header>
          <h2 id="q8" className="text-xl font-bold">
      ...
      {/* Question 9 */}
      <section aria-labelledby="Q9" className="mb-6">
        <header>
          <h2 id="q9" className="text-xl font-bold">
      ...
      {/* Question 10 */}
      <section aria-labelledby="Q10" className="mb-6">
        <header>
          <h2 id="q10" className="text-xl font-bold">
      ...
      {/* Question 11 */}
      <section aria-labelledby="Q11" className="mb-6">
        <header>
          <h2 id="q11" className="text-xl font-bold">
      ...
      {/* Question 12 */}
      <section aria-labelledby="Q12" className="mb-6">
        <header>
          <h2 id="q12" className="text-xl font-bold">
      ...
      {/* Question 13 */}
      <section aria-labelledby="Q13" className="mb-6">
        <header>
          <h2 id="q13" className="text-xl font-bold">
      ...
      {/* Question 14 */}
      <section aria-labelledby="Q14" className="mb-6">
        <header>
          <h2 id="q14" className="text-xl font-bold">
